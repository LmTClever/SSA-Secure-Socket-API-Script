...
# Date: 11/28/2018
#
# Description: This script enables any user to install the Secure Socket API without running into any errors.
...
if [[ $root_check != "root" ]]; then
	...
	echo "[*] Please enter 'su' for Fedora or 'sudo su' for Ubuntu, then enter your root password and try running this script again."
else
